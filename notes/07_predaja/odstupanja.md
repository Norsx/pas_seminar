...
|---|---|---|---|---|---|---|
| ~~1~~ | [[R-08_omni_controller]] [MAIL] | **obavezno** omni_controller | ~~diff_drive_controller, skid-steer~~ → **mecanum_drive_controller** | — | [[D-03_diff_drive_base_temporary]] | ✅ riješeno 13. 9. ([[P-09_omni_drive_on_fortress]]) |
...
| ~~3~~ | [[R-11_door_80cm]] [MAIL] | vrata ~80 cm | ~~2.0 m~~ → **0.9 m od 13. 9.** (tri sobe) | — | [[D-08_door_widened]] → zamijenjena s [[D-13_three_room_world]] | ✅ uklonjeno u svijetu; prolaz se još testira |
...
| ~~7~~ | [[R-06_realistic_parameters]] [ZAD] | realno trenje kotača | ~~mu2 = 0~~ → **mu2 = 0.20** | — | [[P-10_skid_steer_cannot_turn]] | ✅ uklonjeno s #1 (mecanum + mu2=0.20) |
...
- Dimenzije i masa kutije nisu zadane (potvrdio korisnik 13. 9.). Odabrano je 0.30 m / 0.3 kg
  ([[D-14_light_box_free_size]], [[D-06_cube_squeeze_grasp]]).
- Vrata 0.9 m i dva prolaza (tri sobe) su stroži test od „jednog prolaza, recimo 80cm“
