...
\begin{center}
  ...
  {\Large \repourl\par}
  \vspace{1cm}
  {\large Izradili: \textbf{Ivan Noršić i Krešimir Hartl}\par}
\end{center}
\vspace*{\fill}
\clearpage
...
\input{chapters/02-arhitektura}
\input{chapters/03-model-i-okruzenje}
\input{chapters/04-upravljanje}
\input{chapters/05-percepcija}
\input{chapters/06-navigacija}
\input{chapters/07-manipulacija}
\input{chapters/08-misija}
\input{chapters/09-rezultati}
...
\clearpage
\appendix
\input{chapters/prilog-a-pokretanje}
\input{chapters/prilog-b-kod}
